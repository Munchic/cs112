...
spicy_minerva_rand_100 <- spicy_minerva[sample(nrow(spicy_minerva) / 2),]
write.csv(spicy_minerva_rand_100, file = "spicy_minerva.csv")

plot(spicy_minerva$`Amount of food (g)`, spicy_minerva$`Chance to win`, log = "y",
     xlab = "Amount of food consumed per day (g)", ylab = "Chance to win the ghost pepper competition")

if (FALSE) {
  "This data frame aims to evaluate the chance that a Minervan will win
  a national ghost pepper competition by evaluating three factors. These are:
